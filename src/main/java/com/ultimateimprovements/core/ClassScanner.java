...
public final class ClassScanner {
     ...
     * @param packagePrefix фильтр пакета (например "com.ultimateimprovements")
    ...
    public static <A extends Annotation> List<Class<?>> findAnnotatedClasses(
        ...
        try (JarFile jar = new JarFile(jarFile)) {
            ...
            while (entries.hasMoreElements()) {
                ...
                // com/mcplugin/command/subcommands/Example.class → com.ultimateimprovements.command.subcommands.Example
