...
import com.ultimateimprovements.core.PluginShutdown;
import com.ultimateimprovements.core.PluginStartup;
...
public final class ReloadSubcommand {
    ...
    public static boolean execute(CommandSender sender) {
        ...
        sender.sendMessage("§eReloading UltimateImprovements asynchronously...");
