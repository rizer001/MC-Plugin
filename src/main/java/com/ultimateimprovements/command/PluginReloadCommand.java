...
import com.ultimateimprovements.command.subcommands.*;
import com.ultimateimprovements.command.home.HomeCommand;
import com.ultimateimprovements.command.vote.VoteManager;
import com.ultimateimprovements.util.ConsoleLogger;
import static com.ultimateimprovements.command.subcommands.LegacySubCommandAdapter.tc;
...
public class PluginReloadCommand implements CommandExecutor, TabCompleter {
    ...
    public static void init() {
        ...
        com.ultimateimprovements.core.CommandScanner.autoRegister(registry,
                com.ultimateimprovements.core.Main.getInstance(),
        ...
        registry.register(LegacySubCommandAdapter.of("menu", (s, a) -> {
            ...
            com.ultimateimprovements.mechanics.features.omniscanner.AdminMenuGUI.open(p);
            return true;
        }));
