package com.ultimateimprovements.energy.machines.assembler;

import com.ultimateimprovements.core.Keys;
import com.ultimateimprovements.mechanics.features.omniscanner.OmniscannerManager;
...
public class ItemCreatorRecipe {
    ...
    private static ItemStack generatorItem() {
        return com.ultimateimprovements.energy.generation.basic.GeneratorManager.createGeneratorItem();
    }
