package com.ultimateimprovements.whitelist;
...
/**
 * 📋 WhitelistManager — кастомный вайтлист UltimateImprovements.
 * <p>
...
public class WhitelistManager implements Listener {
    ...
    /**
     * Если UltimateImprovements whitelist включён — отключает ванильный и выводит сообщение.
     */
    ...
    public void onPlayerLogin(PlayerLoginEvent e) {
        ...
        if (!isWhitelisted(playerName)) {
            e.disallow(PlayerLoginEvent.Result.KICK_WHITELIST, MessageUtil.legacy(
                    ...
                    "<gray>Use the UltimateImprovements whitelist system.</gray>"
            ));
        }
    }
}
