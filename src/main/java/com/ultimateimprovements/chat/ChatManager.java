package com.ultimateimprovements.chat;
...
public class ChatManager implements Listener {
    ...
    public void onPlayerChat(AsyncPlayerChatEvent event) {
        ...
        // =========================
        if (com.ultimateimprovements.punish.PunishJoinListener.isMuted(player)) {
            event.setCancelled(true);
            var muteRecord = com.ultimateimprovements.punish.PunishJoinListener.getMuteRecord(player);
            if (muteRecord != null) {
