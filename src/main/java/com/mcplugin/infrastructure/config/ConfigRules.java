...
final class ConfigRules {
    ...
    static final List<Rule> ALL = List.of(
            ...
            bool("features.enderchest.quick_close.enabled"),
            integer("features.enderchest.quick_close.threshold_ms", 0, 60000),
            integer("features.enderchest.quick_close.damage", 0, Integer.MAX_VALUE),
            bool("features.enderchest.quick_close.look_away.enabled"),
            dbl("features.enderchest.quick_close.look_away.angle_threshold", 0, 180),
            integer("features.enderchest.quick_close.look_away.explosion_damage", 0, Integer.MAX_VALUE),
