...
final class ConfigRules {
    ...
    static final List<Rule> ALL = List.of(
            ...
            bool("features.creativeitem.enabled"),
            integer("features.creativeitem.max_item_bytes", 1, Integer.MAX_VALUE),
            integer("features.creativeitem.max_total_nbt_size", 1, Integer.MAX_VALUE),
            integer("features.creativeitem.max_recursion_depth", 1, 100),
            integer("features.creativeitem.max_pdc_keys", 0, 10000),
            integer("features.creativeitem.max_lore_lines", 0, 10000),
            integer("features.creativeitem.max_lore_chars", 0, 100000),
            integer("features.creativeitem.max_name_chars", 0, 10000),
            integer("features.creativeitem.max_enchantments", 0, 10000),
