...
import com.mcplugin.command.SubCommandRegistry;
 ...
 * <p>
 * Сканирует пакет {@code com.mcplugin.command.subcommands} в JAR плагина,
...
public final class CommandScanner {
     ...
     * @param scanPackage пакет для сканирования (например "com.mcplugin.command.subcommands")
     */
